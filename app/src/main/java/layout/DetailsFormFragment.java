...
public class DetailsFormFragment extends Fragment {
    ...
    public void onCheckedChangedGender(int checkedId){
        String greetingMessage = "Submit Info";
        if (checkedId == ((RadioButton) view.findViewById(R.id.radioButtonMale)).getId()){
            greetingMessage = "Hey Dude, Submit!";
        } else if (checkedId == ((RadioButton) view.findViewById(R.id.radioButtonFemale)).getId()){
            greetingMessage = "Submit Please, My Lady?";
        }
